...
<div class="wrapper-konten">
	<div class="card">
	  ...
	  <div class="card-body">
	    ...
	    <form action=" <?php echo base_url('tujuan/fungsiTambah_Tj') ?>" method="post">
			<table class="table table-striped">

				<!-- <tr>
					<td>Id tujuan</td>
					<td>:</td>
					<td><input type="text" name="id_tujuan"></td>
				</tr> -->
			
				<tr>
					<td>tujuan</td>
					<td>:</td>
					<td><input type="text" class="form-control" name="tujuan"></td>
				</tr>
