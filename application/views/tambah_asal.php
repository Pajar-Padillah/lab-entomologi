...
<div class="wrapper-konten">
	<div class="card">
	  <h5 class="card-header">Tambah asal</h5>
	  <div class="card-body">
	    <h5 class="card-title"></h5>
	    <form action=" <?php echo base_url('asal/fungsiTambah_Asl') ?>" method="post">
			<table class="table table-striped">

				<!-- <tr>
					<td>Id asal</td>
					<td>:</td>
					<td><input type="text" name="id_asal"></td>
				</tr> -->
