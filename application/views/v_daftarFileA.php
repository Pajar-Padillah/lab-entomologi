...
<body>
	...
	<div class="wrapper-konten">
		...
		<div class="card">
			<h5 class="card-header">Data laporan pengujian</h5>
			<div class="card-body">
				...
				<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
					...
					<tbody>
						<?php
						$count = 0;
						foreach ($queryAllViewFile as $row) {
							$count = $count + 1;
									...
									<td>
										...
										<button type="button" class="btn btn-danger" onclick="Swal.fire({
												...
												if (result.isConfirmed) {
													window.location.href='<?php echo base_url('fungsiDelete_File') ?>/<?php echo $row->id_file ?>';
													Swal.fire(
														'Dihapus!',
								...
								<?php elseif ($this->session->userdata('akses') == '6') : ?>
									<td>
										...
										<button type="button" class="btn btn-danger" onclick="Swal.fire({
												...
												if (result.isConfirmed) {
													window.location.href='file/fungsiDelete_File/<?php echo $row->id_file ?>';
													Swal.fire(
														'Dihapus!',
														'Data Berhasil Dihapus.',
														'success'
