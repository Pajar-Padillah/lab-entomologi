					...
					<tbody>
						...
						foreach ($queryHasilUji as $row){
							...
							<tr>
								...
								<a href="<?php echo base_url('laporan_pdf/lihat_surat_plg') ?>/<?php echo $row->id_pengujian ?>" target="_blank"> <button type="button" class="btn btn-info"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></a></td>
							</tr>
						<?php } ?>
					</tbody>
