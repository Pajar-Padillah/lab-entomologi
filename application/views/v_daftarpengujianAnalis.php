...
<body>
	...
	<div class="wrapper-konten">
		...
		<div class="card">
			<h5 class="card-header">Data Daftar Pengujian</h5>
			<div class="card-body">
					...
					<tbody>
						...
						foreach ($queryDaftarUji as $row){
							...
							<tr>
								...
								<a href="<?php echo base_url('laporan_pdf/lihat_surat') ?>/<?php echo $row->id_pengujian ?>"> <button type="button" class="btn btn-info"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></a></td>
							</tr>
						<?php } ?>
					</tbody>
