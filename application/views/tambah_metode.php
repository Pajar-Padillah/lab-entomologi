...
<div class="wrapper-konten">
	<div class="card">
	  <h5 class="card-header">Tambah metode</h5>
	  <div class="card-body">
	    <h5 class="card-title"></h5>
	    <form action=" <?php echo base_url('metode/fungsiTambah_Mtd') ?>" method="post">
			<table class="table table-striped">

				<!-- <tr>
					<td>Id metode</td>
					<td>:</td>
					<td><input type="text" name="id_metode"></td>
				</tr> -->
			
				<tr>
					<td>metode</td>
					<td>:</td>
					<td><input type="text" class="form-control" name="metode"></td>
				</tr>
