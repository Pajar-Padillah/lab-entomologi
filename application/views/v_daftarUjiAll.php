						...
						?>
							<tr>
								...
								<td>
									...
									<a href="<?php echo base_url('laporan_pdf/lihat_surat') ?>/<?php echo $row->id_pengujian ?>"> <button type="button" class="btn btn-info"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></button></a>
								</td>
							</tr>
						<?php } ?>
					</tbody>
